...
<Library LVVersion="21008000">
	...
	<Item Name="Engine" Type="Folder">
		<Item Name="Init" Type="Folder">
			<Item Name="Initial AIO Parameters.vi" Type="VI" URL="../Initial AIO Parameters.vi"/>
		</Item>
		<Item Name="Run" Type="Folder">
			<Item Name="DAQ Analog In.Async.vi" Type="VI" URL="../DAQ Analog In.Async.vi"/>
			<Item Name="DAQ Analog Out.Async.vi" Type="VI" URL="../DAQ Analog Out.Async.vi"/>
			<Item Name="Initial AI Voltage.vi" Type="VI" URL="../Initial AI Voltage.vi"/>
			<Item Name="Initial AO Voltage.vi" Type="VI" URL="../Initial AO Voltage.vi"/>
		</Item>
		<Item Name="Shut Down" Type="Folder"/>
	</Item>
	<Item Name="Types" Type="Folder">
		<Item Name="AI Properties.ctl" Type="VI" URL="../AI Properties.ctl"/>
		<Item Name="AO Properties.ctl" Type="VI" URL="../AO Properties.ctl"/>
